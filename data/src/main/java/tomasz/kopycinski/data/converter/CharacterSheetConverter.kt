...
fun EntityCharacterSheet.toDomain(): DomainCharacterSheet {
    return DomainCharacterSheet(
        id, name, surname, age, gender, dateOfBirth, destinyPoints, luckPoints, accountMoney, jewelryMoney, barterMoney, notes
    )
}

fun DomainCharacterSheet.toEntity(): EntityCharacterSheet {
    return EntityCharacterSheet(
        name, surname, age, gender, dateOfBirth, destinyPoints, luckPoints, accountMoney, jewelryMoney, barterMoney, notes, id
    )
}
